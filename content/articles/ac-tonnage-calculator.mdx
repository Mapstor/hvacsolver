...
description: "Here's the deal: both could be right, or both could be wrong. AC tonnage depends on far more than square footage alone."
pillar: "calculators"
...
That's why we built this AC tonnage calculator. It uses the same foundational methodology as the **ACCA Manual J** load calculation—the industry standard required by the **International Residential Code (IRC Section N1103.7)**---to estimate your cooling load based on real inputs, not guesswork. If you're also sizing a heating system, see our [furnace sizing calculator](/furnace-sizing-calculator) for the heating counterpart, or our [heating BTU calculator](/heating-btu-calculator) to estimate your heating load.
...
3.  **Your insulation quality.** Newer homes (post-2000) typically have good insulation. Check our [insulation R-value chart](/insulation-r-value-chart) if you're unsure.
...
Considering a heat pump instead? See our [heat pump sizing guide](/heat-pump-sizing).
...
The actual number depends on your climate zone. For the full methodology behind BTU capacity ratings for both [SACC and ASHRAE measurement standards](/btu-sacc-vs-ashrae), see our dedicated explainer.
...
**Recommendation: 5.0-ton AC unit.** Houston's extreme humidity means the system must run long enough to dehumidify—if your AC isn't removing enough moisture, see our guide on [AC not removing humidity](/ac-not-removing-humidity). With newer, well-insulated construction, a 4.0-4.5-ton unit may suffice—this is where a professional Manual J calculation pays for itself.
...
Note that in the Southwest, your AC must also meet **11.7 EER2 minimum** per DOE requirements—not just SEER2. See our [SEER rating explainer](/seer-rating) for more on efficiency ratings.
...
Manual J accounts for over 30 variables that our simplified calculator cannot, including: exact window U-factors and SHGC values, wall construction assembly R-values, blower-door tested infiltration rates (ACH50 converted to natural ACH), duct location and leakage (see our [CFM duct sizing guide](/cfm-duct-sizing) for more on ductwork), solar orientation by wall and window, internal heat gains from appliances and occupants, and local ASHRAE design conditions.
...
According to DOE data, short cycling can increase energy consumption by **15-30%**. The compressor draws 5-7× its normal operating current on each startup, and an oversized system triggers this surge dozens of extra times per day. For more on diagnosing this, see our guide on [AC short cycling](/ac-short-cycling).
...
In humid climates like Houston, Orlando, and Atlanta, this creates conditions that promote mold, dust mites, and bacterial growth. If this is already happening to you, our guide on [AC not removing humidity](/ac-not-removing-humidity) walks through the fixes.
...
This is often misdiagnosed as "not blowing cold enough" when the real problem is oversizing. See our [AC not blowing cold air](/ac-not-blowing-cold) troubleshooting guide for more.
...
For a deeper dive, see our [complete SEER rating guide](/seer-rating).
...
*For a complete guide, see our dedicated* [mini split sizing calculator](/mini-split-sizing)*.*
