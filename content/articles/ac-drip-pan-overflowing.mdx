...
description: "Don't panic---but don't wait, either. A full AC drip pan means water has nowhere to go, and every minute of delay risks ceiling damage, mold growth, and..."
...
If your [AC won't blow cold air](https://hvacsolver.com/ac-not-blowing-cold) and you can't figure out why, a tripped float switch from a full drip pan is one of the most overlooked causes.

## How AC Condensate Drainage Works

Your air conditioner doesn't just cool air—it [removes humidity](https://hvacsolver.com/does-ac-remove-humidity). As warm indoor air passes over the freezing-cold evaporator coil, moisture condenses into water droplets. That's your condensate.
...
This is why your [AC might short-cycle or refuse to turn on](https://hvacsolver.com/ac-short-cycling)---the float switch is doing its job.
...
The higher your [indoor humidity](https://hvacsolver.com/indoor-humidity-guide), the more condensate your system produces. Understanding the relationship between [dew point and condensation](https://hvacsolver.com/dew-point-calculator) helps explain why your drip pan fills faster on muggy days.
...
A dirty [air filter](https://hvacsolver.com/furnace-filter-guide) accelerates the problem—more dust gets past the filter, lands on the coil, and washes into the drain.
...
Ice visible on the evaporator coil or refrigerant lines. When the ice melts (after you turn off the system), it produces a **sudden large volume of water** that overwhelms the drain pan. Your AC was probably [blowing warm air](https://hvacsolver.com/ac-not-blowing-cold) before the freeze.
...
This is a **different problem** than a drip pan overflow, though the two can be related. If you see [water dripping from your AC vent or ceiling register](https://hvacsolver.com/condensation-on-ac-vents), the cause is usually one of these:
...
**Fix:** Wrap ductwork with R-11 or R-13 fiberglass insulation. Check the [insulation R-value chart](https://hvacsolver.com/insulation-r-value-chart) for recommendations specific to your climate zone.
...
**Fix:** Address the root cause of the freeze (dirty filter, low refrigerant). If your AC is [making gurgling or dripping noises](https://hvacsolver.com/ac-making-noise), a frozen coil drip is a likely culprit.
